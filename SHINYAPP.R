...
if (length(find.package(package = "affxparser", quiet = T)) > 0) {
  library(affxparser)
} else {
  print("Package affxparser not installed")
  install.packages("affxparser")
  print("Package affxparser installed")
  library(affxparser)
}
if (length(find.package(package = "AnnotationDbi", quiet = T)) > 0) {
  ...
  print("Package AnnotationDbi installed")
  library(AnnotationDbi)
}
if (length(find.package(package = "maEndToEnd", quiet = T)) > 0) {
  library(maEndToEnd)
} else {
  print("Package maEndToEnd not installed")
  install.packages("maEndToEnd")
  print("Package maEndToEnd installed")
  library(maEndToEnd)
}
